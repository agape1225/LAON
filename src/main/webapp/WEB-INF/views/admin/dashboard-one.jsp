    ...
    <nav class="sidebar">
        ...
        <div class="sidebar-body">
            <ul class="nav">
                ...
                <%--<li class="nav-item">
                    <a href="dashboard-one.jsp" class="nav-link">
        ...
        <div class="sidebar-body">
            ...
            <div class="theme-wrapper">
                ...
                <a class="theme-item active" href="../demo_1/dashboard-one.html">
                    <img src="${path}/assets/images/screenshots/light.jpg" alt="light theme">
                </a>
                <h6 class="text-muted mb-2">Dark Theme:</h6>
                <a class="theme-item" href="../demo_2/dashboard-one.html">
                    <img src="${path}/assets/images/screenshots/dark.jpg" alt="light theme">
                </a>
            </div>
        </div>
    </nav>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4 mb-3">
                                <div class="col-6 d-flex justify-content-end">
                                    <div>
                                        <label class="d-flex align-items-center justify-content-end tx-10 text-uppercase font-weight-medium">Total
                                            storage <span
...
<script src="${path}/resources/admin/assets/vendors/chartjs/Chart.min.js"></script>
<script src="${path}/resources/admin/assets/vendors/jquery.flot/jquery.flot.js"></script>
<script src="${path}/resources/admin/assets/vendors/jquery.flot/jquery.flot.resize.js"></script>
<script src="${path}/resources/admin/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
<script src="${path}/resources/admin/assets/vendors/apexcharts/apexcharts.min.js"></script>
<script src="${path}/resources/admin/assets/vendors/progressbar.js/progressbar.min.js"></script>
...
<script src="${path}/resources/admin/assets/js/dashboard.js"></script>
